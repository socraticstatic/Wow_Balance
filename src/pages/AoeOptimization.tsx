            ...
            <div key={s.stat}>
              <div className="flex items-baseline justify-between mb-1.5">
                ...
                <span className="font-mono text-[12px] font-bold" style={{
                  color: i === 0 ? 'oklch(80% 0.18 80)' : 'oklch(66% 0.012 270)',
              ...
              <p className="text-[11px]" style={{ color: 'oklch(64% 0.012 50)' }}>{s.note}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div ref={r5} className="reveal">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-[13px]" style={{ color: 'oklch(66% 0.012 270)', lineHeight: 1.7 }}>
              ...
              <li className="pl-4" style={{ borderLeft: '2px solid oklch(66% 0.012 270)' }}>
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="space-y-1.5 text-[13px]" style={{ color: 'oklch(66% 0.012 270)' }}>
  ...
  return (
    <div className="flex items-baseline justify-between gap-3 py-1.5" style={{ borderBottom: '1px solid oklch(12% 0.008 270)' }}>
      <div className="flex items-baseline gap-2">
        <span className="text-[12px] font-medium w-14" style={{ color: 'oklch(64% 0.012 50)' }}>{slot}</span>
