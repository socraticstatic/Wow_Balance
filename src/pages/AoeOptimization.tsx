  ...
  return (
    <section className="px-6 sm:px-10 py-28 max-w-6xl mx-auto">
      ...
      <div ref={r2} className="reveal mb-20">
        ...
        {/* Stat priority note */}
        <p className="mt-6 text-[12px] max-w-xl" style={{ color: 'oklch(44% 0.012 270)' }}>
          {aoeBuild.notes}
        </p>
      </div>
            ...
            <div key={s.stat}>
              <div className="flex items-baseline justify-between mb-1.5">
                ...
                <span className="font-mono text-[12px] font-bold" style={{
                  color: i === 0 ? 'oklch(80% 0.18 80)' : 'oklch(58% 0.012 270)',
      ...
      <div ref={r5} className="reveal">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-[13px]" style={{ color: 'oklch(58% 0.012 270)', lineHeight: 1.7 }}>
              ...
              <li className="pl-4" style={{ borderLeft: '2px solid oklch(58% 0.012 270)' }}>
