...
const specTree: TalentRow[] = [
  ...
  { name: 'Wild Surges', points: 1, why: 'Instant Wrath/Starfire procs. Cast while moving.', category: 'throughput' },
  ...
  { name: 'Celestial Alignment', points: 1, why: 'Both Eclipses at once. Unlocks Incarnation.', category: 'cd' },
