      ...
      <div ref={r3} className="reveal rounded-lg overflow-hidden mb-16" style={{ border: '1px solid oklch(14% 0.01 270)' }}>
        ...
        {bisGear.raidMythic.map((item, i) => (
          <div key={item.slot}
            ...
            <div className="col-span-2 text-[12px]" style={{ color: 'oklch(48% 0.012 270)' }}>{item.slot}</div>
      ...
      <div ref={r4} className="reveal">
        ...
        <div className="grid sm:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-[12px]" style={{ color: 'oklch(48% 0.012 270)', lineHeight: 1.6 }}>{bisGear.weapon.notes}</p>
          </div>
          <div>
            ...
            <p className="text-[12px] mb-3" style={{ color: 'oklch(48% 0.012 270)', lineHeight: 1.6 }}>{bisGear.embellishments.first.notes}</p>
            <p className="text-sm font-semibold mb-0.5" style={{ color: 'oklch(88% 0.006 270)' }}>{bisGear.embellishments.second.name}</p>
            <p className="text-[12px]" style={{ color: 'oklch(48% 0.012 270)', lineHeight: 1.6 }}>{bisGear.embellishments.second.notes}</p>
          </div>
        </div>
      </div>
    </section>
