...
function Parallel({ wow, faith, text, accent }: { wow: string; faith: string; text: string; accent: string }) {
  return (
    <div className="p-6 rounded-lg glass card-hover">
      ...
      <div className="text-[10px] uppercase font-bold mb-3" style={{ color: 'oklch(60% 0.012 50)', letterSpacing: '0.1em' }}>
        {faith}
      </div>
      <p className="text-[13px]" style={{ color: 'oklch(58% 0.012 50)', lineHeight: 1.75 }}>
        {text}
      </p>
    </div>
  );
