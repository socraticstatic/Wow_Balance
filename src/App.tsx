...
const sectionIds = ['hero', 'spiracle', 'progression', 'faith', 'aoe', 'breakpoints', 'keybinds', 'builds', 'gear', 'geardelta', 'consumables', 'raid', 'dungeons', 'rankings', 'live', 'changelog', 'setup'] as const;
